...
public class ToDoList {
    ...
    public void onMarkAsDone() {
        ...
        user.getToDoItems().get(itemNumber).setIsDone(Boolean.TRUE);
    }
    ...
    public void onMarkAsUndone() {
        ...
        Scanner scanner = new Scanner(System.in);
        int itemNumber = scanner.nextInt();
        user.getToDoItems().get(itemNumber).setIsDone(Boolean.FALSE);
    }
    ...
    public void onDeleteItem() {
        ...
        if (itemNumber >= 0 && itemNumber < user.getToDoItems().size()) {
            ...
            System.out.println("Invalid item number. No item was deleted.");
        }
    }
